            ...
            <div className="flex">
              <div className="mt-[50px] w-[66.6%] border-white pb-[200px]">
                ...
                <div className="mt-[30px]">
                  <a
                    href="#second-sec"
                    className="text-DeepBlue font-montserrat text-xl font-extrabold leading-7 hover:underline"
                  >
                    view detail &gt;
                  </a>
                </div>
