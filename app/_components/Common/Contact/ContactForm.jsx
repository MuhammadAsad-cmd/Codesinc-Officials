            ...
            <form onSubmit={handleSubmit}>
              <div className="mx-auto w-full bg-white md:max-w-[555px]">
                <input
                  ...
                  className="font-montserrat w-full border-b border-[#cdcdcd] px-5 py-4 text-[15px] font-medium text-[#797979] outline-none"
                  required
                />
                ...
                <div className="relative w-full">
                  <select
                    ...
                    onChange={handleChange}
                    className="font-montserrat w-full appearance-none border-b border-[#cdcdcd] bg-transparent px-5 py-4 text-[15px] font-medium uppercase text-[#969696] outline-none placeholder:text-[#797979]"
                    required
                  >
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="font-montserrat h-[170px] w-full p-5 text-[15px] font-medium text-[#797979] outline-none"
                  rows="4"
                  required
                ></textarea>
              </div>
              <button
                type="submit"
                className="font-montserrat mx-auto mt-[30px] flex h-[49px] items-center justify-center rounded-full border-2 border-white bg-transparent px-[60px] py-2.5 text-lg font-semibold uppercase text-white duration-300 ease-in-out hover:bg-white hover:text-lightblue"
              >
                GET STARTED
              </button>
            </form>
