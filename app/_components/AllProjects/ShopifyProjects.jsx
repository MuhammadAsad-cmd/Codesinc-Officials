"use client";
import { ShopifyProjects, WordpressProjects } from "@/app/Data/Projects";
...
const Shopifyprojects = () => {
  ...
  return (
    <>
      <Head>
        <title>Shopify Development Projects | Portfolio</title>
        <meta
          name="description"
          content="Discover our Shopify development projects featuring custom e-commerce solutions with stunning designs and seamless functionality."
        />
        <meta
          name="keywords"
          content="Shopify Development, Shopify Projects, E-commerce Solutions, Custom Shopify Design, Shopify Portfolio"
        />
        <meta name="author" content="Your Name" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta property="og:title" content="Shopify Development Projects | Portfolio" />
        <meta
          property="og:description"
          content="Explore our Shopify portfolio showcasing professional e-commerce websites with unique designs and intuitive functionality."
        />
        <meta property="og:image" content="/path-to-thumbnail.jpg" />
        <meta property="og:url" content="https://yourwebsite.com/shopify-projects" />
